...
import { delCache } from "../lib/cache.js"
...
export const newProduct = async(req,res) =>{
  ...
  try {
    ...
    await delCache("products:all", "products:featured")
...
export const updateProduct = async(req,res) =>{
  try {
    ...
    await delCache("products:all", "products:featured", `products:category:${updatedProduct.category}`)
...
export const deleteProduct = async(req,res)=>{
  try {
    ...
    await delCache("products:all", "products:featured", `products:category:${del.category}`)

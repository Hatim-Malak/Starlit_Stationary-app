...
const YourOrderPage = () => {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col bg-gradient-to-br from-blue-600 to-blue-700'>
      <Navbar />
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          {gettingOrder && (
            <div className='flex justify-center items-center h-64'>
              <div className='text-center'>
                ...
                <p className='text-blue-100'>Loading your orders...</p>
              </div>
            </div>
          )}
          ...
          {!gettingOrder && (
            <div className='space-y-6'>
              {orders.length === 0 ? (
                <div className='flex flex-col items-center justify-center gap-4 p-16 text-center bg-white border-2 border-dashed border-blue-300 rounded-2xl shadow-lg'>
                  <div className='w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center'>
                    <SearchX className='w-10 h-10 text-blue-600' strokeWidth={1.5} />
                  </div>
                  <div className='mt-2'>
                ...
                orders.map((ord) => {
                  ...
                  return (
                    <div key={ord._id} className='bg-white rounded-xl shadow-xl border-2 border-blue-300 overflow-hidden hover:shadow-2xl transition-shadow duration-200'>
                      {/* Cancellation Notice */}
                      ...
                      <div className='p-6'>
                        ...
                        <div className='mb-6'>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200'>
                            <div className='flex items-start gap-3'>
                              ...
                              <div>
                                <p className='text-xs text-blue-700 font-medium mb-1'>Full Name</p>
                            ...
                            <div className='flex items-start gap-3'>
                              ...
                              <div>
                                <p className='text-xs text-blue-700 font-medium mb-1'>Mobile Number</p>
                            ...
                            <div className='flex items-start gap-3'>
                              ...
                              <div>
                                <p className='text-xs text-blue-700 font-medium mb-1'>Postal Code</p>
                        ...
                        <div className='mb-6'>
                          ...
                          <div className='border-2 border-blue-200 rounded-lg overflow-hidden shadow-md'>
                            ...
                            {/* Grand Total */}
                            <div className='bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-4 border-t-2 border-blue-800'>
                        ...
                        {!(ord.isOrderCanceled.isTrue || ord.isDelivered) && (
                          <div className='mb-6'>
                            <div className='bg-gradient-to-r from-blue-600 to-blue-700 border-l-4 border-blue-900 rounded-lg p-4 shadow-lg'>
                              <div className='flex items-center gap-3 flex-wrap'>
                                ...
                                <div className='flex-1 min-w-0'>
                                  ...
                                  <p className='text-sm text-blue-100'>Share this code with the delivery person to confirm delivery</p>
                                </div>
                                <div className='bg-white px-4 py-2 rounded-lg border-2 border-blue-300 shadow-md'>
                                  <span className='text-2xl font-bold text-blue-600 tracking-wider'>{ord.deliveryOTP.code}</span>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            {cancelId !== ord._id ? (
                              ...
                              >
                                <div>
                                  ...
                                  <textarea
                                    className='w-full px-4 py-3 border-2 border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none resize-none'
                                ...
                                <div className='flex gap-3'>
                                  <button
                                    ...
                                    disabled={cancellingOrder}
                                    className='flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 disabled:opacity-50 shadow-md'
                                  >
                                    Keep Order
                                  </button>
                                  <button
